...
run_command "python train_tinyin.py --net vit_no_ln_s --n_epochs 100 --size 128 --patch 8 --lr 0.01"
...
run_command "python train_tinyin.py --net vit_no_ln_with_init_s --n_epochs 100 --size 128 --patch 8 --lr 0.01"
